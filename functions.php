...
/*
	...
	Description: Website front Sliders function
...
function custom_post_sliders() {
	...
	$args = array(
		'labels'			 => $labels,
		'description'   	 => 'Holds slider specific data',
		'public' 			 => true,
...
register_taxonomy("sliders-category", array("sliders"), array("hierarchical" => true, "label" => "Slider Categories", "singular_label" => "Category", 'show_admin_column' => true, "rewrite" => true));
